...
def main():
    ...
    for index in range(10):
        ...
        if not cap.isOpened():
            print(f"Camera index {index} not opened")
        else:
    ...
    if st.button("Open Webcam"):
        stframe = st.empty()
        st.markdown(
        "<h3 style='color:#EFE8A2'>🎥 Watch the videos and get idea about skin Treatment</h3>",
        unsafe_allow_html=True
         )
        st.markdown(
       "<p style='text-align: justify;color:#ffff'>🌟After watching the videos on skincare treatment, it's evident that a holistic approach is essential. From gentle cleansing to targeted treatments, addressing specific skin concerns is paramount. Incorporating hydrating serums, exfoliants, and SPF protection is crucial. Understanding individual skin types and concerns guides the selection of suitable products. Consistency and patience are key in achieving desired results. Emphasizing hydration, protection, and nourishment ensures skin health and vitality. Consulting a dermatologist for personalized advice can optimize skincare routines. By prioritizing proper skincare practices, one can attain a radiant complexion and boost confidence.</p>",
        unsafe_allow_html=True
        )
        with st.container():
        ...
        with left_column:
            st.markdown(
             f'<iframe width="100%" height="300" src="https://www.youtube.com/embed/gQI7hYL8hpE?si=8vPTujAi18ositsR" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>',
             unsafe_allow_html=True
    )

        with middle_column:
              st.markdown(
              f'<iframe width="100%" height="300" src="https://www.youtube.com/embed/onkB0EN0zas?si=_8TMmmDbfwFZu4oX" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>',
             unsafe_allow_html=True
    )

        with right_column:
             st.markdown(
             f'<iframe width="100%" height="300" src="https://www.youtube.com/embed/0Y7H-GMJ3Dg?si=zSd45MIBAqKGdURE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>',
             unsafe_allow_html=True
    )
        ...
        while cap.isOpened():
            ...
            for (x, y, w, h) in faces:
                ...
                cv2.putText(frame, "Skin Type: {}".format(skin_type), (x, y-10), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 255, 0), 2)
                cv2.putText(frame, "Oilyness Level: {}".format(level), (x, y+20), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 255, 0), 2)
